...
const copy = {
  pt: {
    ...
    sourceText: "FIFA para referencia da tabela, football-data.org para status e placares.",
  ...
  en: {
    ...
    sourceText: "FIFA for schedule reference, football-data.org for status and scores.",
